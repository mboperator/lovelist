...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference("Interaction.count") do
      post interactions_url, params: { interaction: { name: @interaction.name, notes: @interaction.notes, occured_at: @interaction.occured_at } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { name: @interaction.name, notes: @interaction.notes, occured_at: @interaction.occured_at } }
